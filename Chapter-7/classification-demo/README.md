...
It uses the *load_breast_cancer* function from sklearn.datasets to train the data and classify on. This data is initialized in the *app.py* file.
...
* **Brevin Tating** - *Coding for CS150*
