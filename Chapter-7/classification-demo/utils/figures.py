...
def serve_confusion_matrix_table(model, X_test, y_test, Z, threshold):
    ...
    # Define table data in a familiar confusion matrix format:
    #                Predicted Positive   Predicted Negative
    # Actual Positive        TP                    FN
    # Actual Negative        FP                    TN
    table_columns = [
        {"name": "", "id": "Actual"},
        {"name": "Predicted Positive", "id": "PredPos"},
        {"name": "Predicted Negative", "id": "PredNeg"}
    ]
    table_data = [
        {"Actual": "Actual Positive", "PredPos": tp, "PredNeg": fn},
        {"Actual": "Actual Negative", "PredPos": fp, "PredNeg": tn}
    ]
